...
const Draft = () => {
    const teamTunaPhishPlayers = ["Abrafebre","Abusivetunaa","bongij_mi","ChNPP","Cuhmmies","connorz","Desports Btw","Deus Iron","Fe brimstone","Frelya","Goose L","IM Ivar","Iron Chkn","J_mes","Joan of Arf","Justen","MilkMate","MXIIA","Noble Mobile","I run East","Sailor Terry","Sacred Clays","KinuskiCorie","Shaharrav","Tiiiiiiiiiim","Vyraal1","Vorkathchan","Zero Rangers"];
